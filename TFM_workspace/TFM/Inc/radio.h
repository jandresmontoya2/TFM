...
/* FRTA este bloque no esta en v3.3 */
//#define SX_NSS_Pin	   GPIO_PIN_1
																// XXX *ANDRES
#define SX1276_NSS_LOW()         HAL_GPIO_WritePin(GPIOA , SX1276_NSS_Pin, RESET );	//HAL_GPIO_WritePin(SX_NSS_GPIO_Port, SX_NSS_Pin, RESET);
#define SX1276_NSS_HIGH()        HAL_GPIO_WritePin(GPIOA , SX1276_NSS_Pin, SET );		//HAL_GPIO_WritePin(SX_NSS_GPIO_Port, SX_NSS_Pin, SET);

#define SX1276_RESET_HIGH() 	HAL_GPIO_WritePin(GPIOA, SX1276_NRESET_Pin, SET); 	//HAL_GPIO_WritePin(SX_RST_GPIO_Port, SX_RST_Pin, SET); //Reset
#define SX1276_RESET_LOW() 		HAL_GPIO_WritePin(GPIOA, SX1276_NRESET_Pin, RESET); 	//HAL_GPIO_WritePin(SX_RST_GPIO_Port, SX_RST_Pin, RESET); //Reset

/* FRTA Banda y modo de la configuracion */
//#define USE_BAND_433
//#define USE_MODEM_FSK
#define USE_BAND_915		// XXX-andres
#define USE_MODEM_LORA		// XXX-andres
...
#define BUFFER_SIZE                                 6 // XXX-andres
